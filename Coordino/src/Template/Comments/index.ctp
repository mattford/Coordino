    ...
    <table cellpadding="0" cellspacing="0">
        <thead>
            <tr>
                ...
                <th><?= $this->Paginator->sort('related_id') ?></th>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><?= $this->Number->format($comment->related_id) ?></td>
                <td><?= $this->Number->format($comment->timestamp) ?></td>
                <td><?= $this->Number->format($comment->votes) ?></td>
